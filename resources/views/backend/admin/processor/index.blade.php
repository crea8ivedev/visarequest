...
<div class="row">
    ...
    <div class="card card-custom">
      <div id="showResponseArea" class="showResponseArea alert hide">
        ...
        <div class="card-body">
            ...
            <table class="table table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="processor_table">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Email</th>
  ...
  <div class="col-md-4">
    ...
    <div class="card card-custom card-collapse"   data-card="true" id="kt_card_4">
        <div class="card-header">
          <div class="card-title">
              <h3 class="card-label">Processor</h3>
          </div>
...
@section('scripts')
    ...
    $(document).ready(function() {
      ...
      $('#sample_form').on('submit', function(event) {
        ...
        if($('#action').val() == 'Add')
        {
         action_url = "{{ route('admin.processor.store') }}";
        }

        if($('#action').val() == 'Edit')
        {
         action_url = "{{ route('admin.processor.update') }}";
        }
        ...
        $.ajax({
           ...
           success:function(data)
           {
            ...
            {
                $('#sample_form')[0].reset();
                $('#processor_table').DataTable().ajax.reload();
      ...
      $(document).on('click', '.edit', function() {
        ...
        var id = $(this).attr('id');
        var url = '{{ route("admin.processor.edit", ":id") }}';
     ...
     $('#ok_button').click(function(){
        var url = '{{ route("admin.processor.destroy", ":id") }}';
