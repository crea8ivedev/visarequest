    ...
    <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            <span class="card-icon">{{ Metronic::getSVG("public/images/icons/Add-user.svg", "svg-icon-xm svg-icon-primary") }}</span>
            <h3 class="card-label">Processors</h3>
          </div>
          <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{route('admin.processor.add')}}" class="btn btn-primary font-weight-bolder">
...
@section('scripts')
    ...
    <script src="{{ asset('js/pages/processor.js') }}" type="text/javascript"></script>
