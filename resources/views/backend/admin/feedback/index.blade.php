    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
          <div class="mb-7">
                ...
                <div class="row align-items-center">
                  <div class="col-md-6 my-2 my-md-0">
                    <div class="input-icon">
                      <input type="text" class="form-control search" placeholder="Search by name, email" id="kt_datatable_search_query">
            ...
            <table class="table datatable table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="feedback_table">
                <thead>
                    <tr>
                        <th>Type</th>
                        <th>Name</th>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-titles">Feedback</h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <form method="post" id="sample_form" class="form-horizontal" action="{{ route('admin.feedback.update')  }}">
...
@section('scripts')
    ...
    <script src="{{ asset('js/pages/feedback.js') }}" type="text/javascript"></script>
@endsection