        ...
        <div class="form-group row">
          ...
          <div class="col-lg-6">
            ...
            <select class="form-control" id="processor_id" name="processor_id">
              ...
              <option value="{{ $staff->id }}" {{ $staff->id ==$data->processor_id  ? 'selected="selected"' : '' }}>{{ $staff->name }}</option>
              @endforeach
            </select>
        ...
        <div class="form-group row">
          <div class="col-lg-6">
            ...
            <select class="form-control" id="agent_id" name="agent_id">
              ...
              <option value="{{ $agent->id }}" {{ $agent->id ==$data->agent_id  ? 'selected="selected"' : '' }}>{{ $staff->name }}</option>
              @endforeach
            </select>
