...
<div class="col-md-12">
  ...
  <div class="card card-custom card-collapse" data-card="true" id="kt_card_4">
    ...
    <div class="card-body" id="card-collapse">
      <!--begin::Form-->
      <form class="form" method="post" id="sample_form" action="{{ url('admin/news/update/'.$data->id) }}">
        @csrf
        ...
        <div class="col-lg-6">
         ...
         <div class="col-lg-6">
          ...
          <input class="form-control" id="heading" name="heading" placeholder="Heading" value="{{$data->heading ?? ''}}">
