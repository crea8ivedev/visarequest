    ...
    <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            <span class="card-icon"><i class="far fa-list-alt text-primary"></i></span>
        ...
        <div class="card-body">
          <div class="mb-7">
            ...
            <table class="table datatable table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="service_category_table">
                <thead>
                    <tr>
                        <th>Category Name</th>
                        <th>Action</th>
