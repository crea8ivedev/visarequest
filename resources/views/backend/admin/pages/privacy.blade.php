...
<div class="col-md-12">
    ...
    <div class="card card-custom card-collapse"   data-card="true" id="kt_card_4">
        <div class="card-header">
          <div class="card-title">
            <span class="card-icon"><i class="fas fa-tag text-primary"></i></span>
              <h3 class="card-label">Privacy</h3>
          </div>
        ...
        <div class="card-body" id="card-collapse"  >
          <!--begin::Form-->
          <form class="form" method="post" id="sample_form" action="{{ route('admin.privacy.store')  }}">
            @csrf
...
{!! JsValidator::formRequest('App\Http\Requests\Backend\PrivacyRequest') !!}
