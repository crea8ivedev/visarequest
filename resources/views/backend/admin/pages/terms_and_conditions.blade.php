    ...
    <div class="card card-custom card-collapse"   data-card="true" id="kt_card_4">
        <div class="card-header">
          <div class="card-title">
            <span class="card-icon"><i class="fas fa-gavel text-primary"></i></span>
            <h3 class="card-label">Terms And Conditions</h3>
          </div>
        ...
        <div class="card-body" id="card-collapse"  >
          <!--begin::Form-->
          <form class="form" method="post" id="sample_form" action="{{ route('admin.terms-and-conditions.store')  }}">
            @csrf
...
{!! JsValidator::formRequest('App\Http\Requests\Backend\TermsAndConditionRequest') !!}
