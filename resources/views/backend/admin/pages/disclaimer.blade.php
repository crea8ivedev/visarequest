  ...
  <div class="card card-custom card-collapse" data-card="true" id="kt_card_4">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Disclaimer</h3>
      </div>
    ...
    <div class="card-body" id="card-collapse">
      <!--begin::Form-->
      <form class="form" method="post" id="sample_form" action="{{ route('admin.disclaimer.store')  }}">
        @csrf
        ...
        <div class="form-group">
          ...
          <div class="input-group">
            <input type="text" class="form-control" name="heading" id="heading" placeholder="Heading"
              value="{{ $data->heading ?? '' }}" autocomplete="off" />
          </div>
        </div>

        <div class="form-group">
          <label>Description :<code>*</code></label>
          <textarea placeholder="Description" class="form-control  kt-ckeditor-1" id="description" name="description"
...
{!! JsValidator::formRequest('App\Http\Requests\Backend\DisclaimerRequest') !!}
