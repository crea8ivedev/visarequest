        ...
        <div class="card-body" id="card-collapse">
            ...
            <form class="form" method="post" id="sample_form" action="{{ route('admin.meta-page.store')  }}">
                ...
                <div class="form-group">
                    ...
                    <textarea rows="7" placeholder="Description" class="form-control" id="description"
                        name="description" autocomplete="off">{{ $data->description ?? '' }}</textarea>
                </div>
                ...
                <div class="card-footer">
                    ...
                    <button type="submit" id="submit"
                        class="btn btn-primary mr-2">{{ $data ? 'Update' : 'Add'}}</button>
