  ...
  <div class="col-md-12">
    ...
    <div class="card card-custom">
        <div class="card-header">
          ...
          <span class="card-icon"><i class="fas fa-sliders-h text-primary"></i></span>
            <h3 class="card-label">Sliders</h3>
          </div>
          <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{route('admin.slider.add')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
          <div class="mb-7">
            ...
            <table class="table datatable table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="slider_table">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Action</th>
...
@section('scripts')
    ...
    @foreach(config('layout.resources.sweetalert') as $script)
        <script src="{{ asset($script) }}" type="text/javascript"></script>
    @endforeach
    <script src="{{ asset('js/pages/slider.js') }}" type="text/javascript"></script>
@endsection