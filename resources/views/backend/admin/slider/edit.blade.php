...
<div class="col-md-12">
    ...
    <div class="card card-custom card-collapse"   data-card="true" id="kt_card_4">
        ...
        <div class="card-body" id="card-collapse"  >
          <!--begin::Form-->
          <form class="form" method="post" id="sample_form" enctype="multipart/form-data" action="{{ url('admin/slider/update/'.$data->id) }}">
            @csrf
             
               <div class="form-group row {{ $errors->has('name') ? 'is-invalid' : '' }}">
                <div class="col-lg-12">
                  <label>Name :<code>*</code></label>
                    <input type="text" class="form-control" name="name" id="name" placeholder="Name" autocomplete="off"  value="{{ $data->name ?? ''}}" />
                  @if ($errors->has('name'))
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-12">
                   <div class="image-input image-input-outline" id="kt_image_1">
                      <div class="image-input-wrapper desktop_banner" style="background-image: url({{ asset(config("constants.SLIDER_IMAGE_GET")).'/'.$data->image ?? asset("images/slider.png") }})"></div>
