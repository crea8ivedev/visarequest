  ...
  <div class="card card-custom card-collapse" data-card="true" id="kt_card_4">
    <div class="card-header">
      <div class="card-title">
        <h3 class="card-label">Edit Email Template</h3>
      </div>
    ...
    <div class="card-body" id="card-collapse">
      <!--begin::Form-->
      <form class="form" method="post" id="sample_form"  action="{{ url('admin/email-template/update/'.$data->id) }}">
        @csrf
        <div class="form-group row">
          ...
          <div class="col-lg-6">
            ...
            <input type="email" class="form-control" id="sender_email" name="sender_email" placeholder="Sender Email" value="{{ $data->sender_email ?? '' }}">
        ...
        <div class="form-group {{ $errors->has('message') ? ' has-error' : '' }}">
            <label>Message :<code>*</code></label>
              <textarea class="form-control" id="message" name="message" placeholder="Message">{{ $data->message ?? ''}}</textarea>
