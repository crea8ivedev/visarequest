    ...
    <div class="card card-custom">
        <div class="card-header">
          ...
          <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{route('admin.team-member.add')}}" class="btn btn-primary font-weight-bolder">
        ...
        <div class="card-body">
          <div class="mb-7">
                ...
                <div class="row align-items-center">
                  <div class="col-md-6 my-2 my-md-0">
                    <div class="input-icon">
                      <input type="text" class="form-control search" placeholder="Search by name, email, position..." id="kt_datatable_search_query">
            ...
            <table class="table datatable table-bordered table-checkable dataTable no-footer dtr-inline collapsed" id="team_member_table">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Position</th>
...
@section('scripts')
    ...
    <script src="{{ asset('js/pages/team_member.js') }}" type="text/javascript"></script>
