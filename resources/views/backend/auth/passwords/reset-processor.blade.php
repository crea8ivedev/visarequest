...
<!DOCTYPE html>
<!--
Template Name: Metronic - Bootstrap 4 HTML, React, Angular 9 & VueJS processor Dashboard Theme
Author: KeenThemes
...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		title>{{ config('app.name') }} | Processor Reset Password </title>
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 ml-auto mr-auto">
					...
					<div class="d-flex flex-column-fluid flex-center mt-6 mt-lg-0">
						...
						<div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form" method="POST" action="{{ route('processor.password.request') }}">
                                {{ csrf_field() }}
                                <input type="hidden" name="token" value="{{ $token }}">
								<!--begin::Title-->
								<div class="text-center pt-lg-40 mt-lg-20 pb-15">
									<h3 class="font-weight-bolder text-dark display5">Processor Reset Password ?</h3>
						...
						<div class="login-form login-forgot">
							...
							<form class="form" novalidate="novalidate" id="kt_login_forgot_form" action="{{ route('password.request') }}">
								...
								<div class="form-group d-flex flex-wrap flex-center pb-lg-0">
                                    ...
                                    <a href="{{ route('processor.login') }}" class="btn btn-light-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mx-4">Cancle</a>
								</div>
								<!--end::Form group-->
							</form>
							<!--end::Form-->
