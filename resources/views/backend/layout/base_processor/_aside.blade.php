 <div class="aside aside-left d-flex flex-column" id="kt_aside">
    ...
    <div class="aside-nav d-flex flex-column align-items-center flex-column-fluid pb-10">
        ...
        <ul class="nav flex-column">
                ...
                <a href="{{ route('processor.dashboard') }}" class="nav-link btn btn-icon btn-hover-text-primary btn-lg {{ (request()->is('processor')) ? 'active' : '' }}">
                    <span class="svg-icon svg-icon-xxl">
                        <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                         {{ Metronic::getSVG('public/media/svg/icons/Layout/Layout-4-blocks.svg') }}
                        <!--end::Svg Icon-->
                    </span>
                </a>
            </li>
            ...
            <li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Requirements">
                <a href="{{ route('processor.profile') }}" class="nav-link btn btn-icon btn-hover-text-primary btn-lg {{ (request()->is('processor/profile')) ? 'active' : '' }}"  role="tab">
                    <span class="svg-icon svg-icon-xxl">
            ...
            <li class="nav-item mb-2" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Project Management">
                <a href="#" class="nav-link btn btn-icon btn-hover-text-primary btn-lg" data-toggle="tab" data-target="#kt_aside_tab_4" role="tab">
                    <span class="svg-icon svg-icon-xxl">
    ...
    <div class="aside-footer d-flex flex-column align-items-center flex-column-auto py-8">
        ...
        <div class="dropdown" data-toggle="tooltip" data-placement="right" data-container="body" data-boundary="window" title="Languages">
            <a href="#" class="btn btn-icon btn-hover-text-primary btn-lg" data-toggle="dropdown" data-offset="0px,0px">
                <img class="w-20px h-20px rounded" src="{{ asset('media/svg/flags/226-united-states.svg') }}" alt="image" />
            </a>
            <!--begin::Dropdown-->
