                ...
                <div class="d-flex align-items-baseline mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('processor.dashboard') }}" class="text-muted">dashboard</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="d-flex flex-row">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                    @if($user->profile_image != "" && file_exists( public_path().'/images/uploads/profile/'.$user->profile_image))
                                        <div class="symbol-label" style="background-image:url({{asset("public/images/uploads/profile/".$user->profile_image)}})"></div>
                                    @else
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="{{ route('processor.profile') }}" class="navi-link py-4 active">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="{{ route('processor.change_password') }}" class="navi-link py-4">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                ...
                <div class="flex-row-fluid ml-lg-8">
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        @endif
                        <!--begin::Form-->
                        <form method="post" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"  action="{{route('processor.profile.post')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <!--begin::Body-->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            <div class="input-group-prepend">
                                             ...
                                             <input type="tel" class="form-control  form-control-lg" name="phone_number" placeholder="phone" value="{{ $user->phone_number }}">
