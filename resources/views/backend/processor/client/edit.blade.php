            ...
            @csrf
              ...
              <div class="form-group row {{ $errors->has('first_name') ? 'is-invalid' : '' }}">
                <div class="col-lg-6">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" name="first_name" id="first_name" placeholder="First name"  value="{{ $data->first_name ?? ''}}" autocomplete="off" />
                  </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" id="last_name" name="last_name"  placeholder="Last name" value="{{ $data->last_name ?? ''}}" autocomplete="off" />
                    </div>
              ...
              <div class="form-group row  {{ $errors->has('email') ? ' has-error' : '' }}">
                 <div class="col-lg-6">
                    ...
                    <div class="input-group">
                      <input type="email" class="form-control" name="email" id="email" placeholder="Email" value="{{ $data->email ?? ''}}" autocomplete="off" />
                    </div>
                    @if ($errors->has('email'))
                        <span class="help-block">
                 ...
                 <div class="col-lg-6">
                    ...
                    <div class="input-group">
                      <input type="text" class="form-control" name="phone" id="phone" placeholder="Phone number"  value="{{ $data->phone ?? ''}}" autocomplete="off" />
                    </div>
                    @if ($errors->has('phone'))
                        <span class="help-block">
