    ...
    <div class="card card-custom">
        <div class="card-header">
          <div class="card-title">
            <span class="card-icon">{{ Metronic::getSVG("public/images/icons/Clipboard-check.svg", "svg-icon-xm svg-icon-primary") }}</span>
            <h3 class="card-label">Completed Services</h3>
          </div>
