            ...
            <div class="d-flex flex-row">
                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                <div class="navi-item mb-2">
                                    <a href="{{ route('agent.profile') }}" class="navi-link py-4 active">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="{{ route('agent.change_password') }}" class="navi-link py-4">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                ...
                <div class="flex-row-fluid ml-lg-8">
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        @endif
                        <!--begin::Form-->
                        <form method="post" class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"  action="{{route('agent.profile.post')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            <!--begin::Body-->
                            <div class="card-body">
                                <div class="row">
