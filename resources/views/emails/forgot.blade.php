                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://visarequest.co.zw/"
                                ...
                                <img src="http://visarequest.co.zw/images/logo.png" height="100px" />
                            </a>
                        </td>
                    </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                <table border="0" width="100%" cellpadding="0"
                                                                    ...
                                                                    <tr>
                                                                        <td
                                                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; width: 100%">
                                                                            <a
                                                                                href="{{ route('user.forgot.form',[$token]) }}">Click
                                                                                here for reset password</a>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{ date('Y') }} VisaRequest. All rights reserved.</p>
