...
<section class="category-row pt-0 pb-0">
    ...
    <div class="container ">
        <div class="row row-eq-height">
            ...
            <div class="col-lg-8">
                <form id="profile_form" class="contact_form wrap-form clearfix pt-60 pb-60" method="post" action="{{ route('frontend.user.profile.update')  }}">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="cmt-btn cmt-btn-size-md cmt-btn-shape-round cmt-btn-style-border cmt-btn-color-dark cmt-color" type="submit" />
                        </div>
                    </div>
                </form>
            </div>
