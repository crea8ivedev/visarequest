     ...
     */
     ...
     {   
         ...
         if ($request->hasFile('image')) {
            ...
            $image->storeAs(Config::get('constants.SLIDER_STORE'), $save_name);
     ...
     public function update(SliderRequest $request)
     {
         ...
         if ($request->hasFile('image')) {
            $old_path = Storage::disk()->path(Config::get('constants.SLIDER_STORE').'/'.$request->old_image);
            //dd($old_path);B
     ...
     public function destroy($id)
     {
       ...
       $old_path = Storage::disk()->path(Config::get('constants.SLIDER_STORE').'/'.$slider->image);
        if(File::exists($old_path)) {
            File::delete($old_path);
        }
